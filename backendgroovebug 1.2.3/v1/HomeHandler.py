...
# Use GetArtistNews method to obtain news data for given artist
        ...
        if currentUser is None:
            ...
            facebookFavoritesJson = currentUser.facebookFavoritesJson
            facebookFavorites = currentUser.facebookFavorites
            if not facebookFavoritesJson == None:
                facebookFavoritesData = json.loads(facebookFavoritesJson.encode('utf-8'))
